...
describe('EmployeeController', () => {
  ...
  beforeEach(async () => {
    const mockEmployeeRepository = {
      ...
      findOne: jest.fn().mockImplementation((_id) => Promise.resolve(new Employee())),
      create: jest.fn().mockImplementation((_dto) => Promise.resolve(new Employee())),
    ...
    const mockEmployeeDetailRepository = {
      ...
      findOne: jest.fn().mockImplementation((_id) => Promise.resolve(new EmployeeDetail())),
      create: jest.fn().mockImplementation((_dto) => Promise.resolve(new EmployeeDetail())),
